...
const { CaptureControl, DxgiDuplicationSession, Frame, ImageEncoder, ScreenCapture, VideoEncoder, AudioCodec, captureApiSupport, ColorFormat, ContainerFormat, DxgiDuplicationFormat, enumerateMonitors, enumerateWindows, foregroundWindow, ImageEncoderPixelFormat, ImageFormat, isSupported, monitorFromIndex, primaryMonitor, VideoCodec, windowFromContainsName, windowFromHandle, windowFromName } = nativeBinding
export { CaptureControl }
export { DxgiDuplicationSession }
export { Frame }
export { ImageEncoder }
export { ScreenCapture }
export { VideoEncoder }
export { AudioCodec }
export { captureApiSupport }
export { ColorFormat }
export { ContainerFormat }
export { DxgiDuplicationFormat }
export { enumerateMonitors }
export { enumerateWindows }
export { foregroundWindow }
export { ImageEncoderPixelFormat }
export { ImageFormat }
export { isSupported }
export { monitorFromIndex }
export { primaryMonitor }
export { VideoCodec }
export { windowFromContainsName }
export { windowFromHandle }
export { windowFromName }
